...
#' @return A character vector that contains the nodes of the graph ordered
...
#'     \code{\link{as.dag}}, \code{\link{is.cyclic}}/\code{\link{is.acyclic}},
#'     and \code{\link{as.pattern}}
#' @references Cormen, Thomas H., et al. Introduction to Algorithms. The MIT
#'     Press, 2014.
#' @useDynLib causality r_causality_sort
#' @export
